    ...
    <>
      <div className="site-shell">
        ...
        <main id="main">
          ...
          >
            <div className="section-heading split-heading">
              <div>
                ...
                <h2 id="services-title">
                  Services designed to feel premium, clear, and easy to use.
                </h2>
              </div>
            </div>
            ...
            <div className="carousel-shell" data-carousel>
              <div className="carousel-header">
                <div>
                  <p className="carousel-label">Membership features</p>
                </div>
              ...
              <div
                className="carousel-track service-track"
                tabIndex={0}
                aria-label="Membership feature cards"
              >
                <article className="service-card panel">
                  <span className="service-icon">01</span>
                  <h3>Group training</h3>
                  <p>
                    High-energy sessions with coach attention, clear structure,
                ...
                <article className="service-card panel">
                  ...
                  <p>
                    One-to-one coaching for members who want a more tailored
                    path, more detailed feedback, and tighter support.
                  </p>
                </article>
                <article className="service-card panel">
                  ...
                  <p>
                    Your membership is backed by a dashboard that helps keep
                    sessions, notes, and training visibility organized.
                  </p>
                </article>
                <article className="service-card panel">
                  ...
                  <p>
                    Coaches can share plans, guidance, and useful training
                    material in a format that feels much easier to follow.
                  </p>
                </article>
              </div>
            </div>
          ...
          <section className="section-shell section-grid" aria-labelledby="why-title">
            <div className="section-heading split-heading">
              <div>
                <div className="eyebrow">Why members prefer it</div>
                <h2 id="why-title">
                  A calmer, more organized studio experience with higher standards.
                </h2>
              </div>
            </div>
            ...
            <div className="carousel-shell" data-carousel>
              <div className="carousel-header">
                <div>
                  <p className="carousel-label">Studio benefits</p>
                </div>
                <div className="carousel-controls">
                  <button
                    className="carousel-btn"
              ...
              <div
                className="carousel-track benefit-track"
                tabIndex={0}
                role="list"
                aria-label="Studio benefits"
              >
                <article className="benefit-card panel" role="listitem">
                  <strong>3k+</strong>
                  <h3>Sessions supported</h3>
                  <p>
                    Members train inside a system that is built to keep routines
                    visible and easier to sustain.
                  </p>
                </article>
                <article className="benefit-card panel" role="listitem">
                  <strong>12</strong>
                  <h3>Sessions every month</h3>
                  <p>
                    A clearer monthly structure gives the membership real rhythm
                    instead of vague attendance promises.
                  </p>
                </article>
                <article className="benefit-card panel panel-accent" role="listitem">
                  <strong>2</strong>
                  <h3>Ways to train</h3>
                  <p>
                    Choose between premium group sessions and private coaching
                    without losing the same quality standard.
                  </p>
                </article>
                <article className="benefit-card panel" role="listitem">
                  <strong>24h</strong>
                  ...
                  <p>
                    New registrations are treated as onboarding, with a faster,
                    clearer next step after you apply.
                  </p>
                </article>
              </div>
            </div>
          ...
          <section className="section-shell section-grid" aria-labelledby="plans-title">
            <div className="section-heading split-heading">
              <div>
                <div className="eyebrow">Membership paths</div>
                <h2 id="plans-title">
                  Choose the format that matches how you want to train.
                </h2>
              </div>
            </div>
            ...
            <div className="carousel-shell" data-carousel>
              <div className="carousel-header">
                <div>
                  <p className="carousel-label">Membership options</p>
                </div>
                <div className="carousel-controls">
                  <button
                    className="carousel-btn"
              ...
              <div
                className="carousel-track plan-track"
                tabIndex={0}
                aria-label="Membership plans"
              >
                <article className="plan-card panel">
                  <div className="plan-top">
                    <span className="plan-tag">Group membership</span>
                    <h3>Train with energy and consistency.</h3>
                  </div>
                  <ul className="plan-list">
                    <li>12 structured sessions per month</li>
                    <li>Coach support in every class</li>
                    <li>High-accountability training environment</li>
                  </ul>
                  <button
                    className="btn btn-secondary btn-plan"
                    type="button"
                    data-scroll-to="#contact"
                  >
                ...
                <article className="plan-card panel panel-accent">
                  <div className="plan-top">
                    <span className="plan-tag">Private coaching</span>
                    <h3>Choose a more tailored coaching experience.</h3>
                  </div>
                  <ul className="plan-list">
                    <li>One-to-one sessions built around your goals</li>
                    <li>More focused progression and feedback</li>
                    <li>Premium support for members who want extra guidance</li>
                  </ul>
                  <button
          ...
          >
            <div className="section-heading split-heading">
              <div>
                <div className="eyebrow">Meet the coaches</div>
                <h2 id="coaches-title">
                  Experienced trainers behind the studio standard.
                </h2>
              </div>
            </div>
            ...
            <div className="carousel-shell" data-carousel>
              <div className="carousel-header">
                <div>
                  <p className="carousel-label">Coaching team</p>
                </div>
                <div className="carousel-controls">
                  <button
                    className="carousel-btn"
              ...
              <div className="carousel-track coach-track" tabIndex={0} aria-label="Coach cards">
                <article className="coach-card panel">
                  <div className="coach-mark">H</div>
                  <h3>Ahmed Waheed (Heda)</h3>
                ...
                <article className="coach-card panel">
                  <div className="coach-mark">H</div>
                  <h3>Hisham Mostafa</h3>
                  <p className="coach-role">Performance Coach</p>
                  <div className="coach-tags">
                ...
                <article className="coach-card panel">
                  <div className="coach-mark">F</div>
                  <h3>Ahmed Farouk</h3>
                  <p className="coach-role">Group Coach</p>
                  <div className="coach-tags">
                    <span>HIIT</span>
                    <span>Fat Loss</span>
                  </div>
                ...
                <article className="coach-card panel">
                  <div className="coach-mark">Y</div>
                  <h3>Youssef Abdelatif</h3>
                  <p className="coach-role">Private Coach</p>
                  <div className="coach-tags">
                    <span>Mobility</span>
                    <span>Endurance</span>
                  </div>
                ...
                <article className="coach-card panel">
                  <div className="coach-mark">Z</div>
                  <h3>Abdullah Zaki</h3>
                  <p className="coach-role">Group Coach</p>
                  <div className="coach-tags">
                    <span>Cardio</span>
                ...
                <article className="coach-card panel">
                  <div className="coach-mark">R</div>
                  <h3>Reham Badawy</h3>
                  <p className="coach-role">Private Coach</p>
                  <div className="coach-tags">
                    <span>Nutrition</span>
          ...
          >
            <div className="section-heading split-heading">
              <div>
                <div className="eyebrow">Member feedback</div>
                <h2 id="reviews-title">
                  What members notice once they train inside a better system.
                </h2>
              </div>
            </div>
            ...
            <div className="carousel-shell" data-carousel>
              <div className="carousel-header">
                <div>
                  <p className="carousel-label">Testimonials</p>
                </div>
                <div className="carousel-controls">
                  <button
                    className="carousel-btn"
              ...
              <div className="carousel-track review-track" tabIndex={0} aria-label="Review cards">
                <article className="review-card panel">
                  <div className="review-stars" aria-label="5 out of 5 stars">
                    &#9733;&#9733;&#9733;&#9733;&#9733;
                  </div>
                  <p>
                    &quot;The coaches here do not let you drift. The whole experience
                    feels more serious, more organized, and much easier to stay
                    consistent with.&quot;
                  </p>
                ...
                <article className="review-card panel">
                  ...
                  <p>
                    &quot;Private coaching gave me much more clarity. My sessions feel
                    intentional now, and I always know what I am working toward.&quot;
                  </p>
                  <div className="review-person">
                ...
                <article className="review-card panel">
                  ...
                  <p>
                    &quot;Group training here has real structure. The energy is strong,
                    but the coaching is what makes it feel genuinely high quality.&quot;
                  </p>
                  <div className="review-person">
                    <strong>Mohamed H.</strong>
