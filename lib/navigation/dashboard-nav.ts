...
const dashboardNavConfig: Record<OpsRole, DashboardNavItem[]> = {
  admin: [
    ...
    },
    {
      ...
      href: "/admin/leads",
      icon: ClipboardList,
      description: "Prospect follow-ups & trial session conversion",
      section: "primary",
      available: true,
    },
    {
      label: "Lapsed Trials",
      href: "/admin/lapsed-trials",
      icon: CalendarClock,
      description: "Attended a trial, never followed up",
      section: "primary",
      available: true,
    },
    {
      label: "Inactive Leads",
      href: "/admin/inactive-leads",
      icon: UserRoundX,
      description: "Lost or converted, kept for reporting",
      section: "primary",
      available: true,
    },
    {
      ...
      href: "/admin/clients",
      icon: Users,
      description: "Member profiles, injury alerts & cash-out ledger",
      section: "primary",
      available: true,
    },
    {
