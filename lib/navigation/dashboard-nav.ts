...
const dashboardNavConfig: Record<OpsRole, DashboardNavItem[]> = {
  admin: [
    ...
    { label: "Programs", href: "/admin/categories", icon: UsersRound, description: "Categories, groups & schedules", section: "primary", available: true },
  ...
  coach: [
    ...
    { label: "Programs", href: "/coach/categories", icon: UsersRound, description: "Programs I supervise", section: "primary", available: true },
