...
const dashboardNavConfig: Record<OpsRole, DashboardNavItem[]> = {
  admin: [
    ...
    { label: "Categories & Groups", href: "/admin/categories", icon: UsersRound, description: "Programs & recurring groups", section: "primary", available: true },
  ...
  coach: [
    ...
    { label: "Categories", href: "/coach/categories", icon: UsersRound, description: "Programs I supervise", section: "primary", available: true },
