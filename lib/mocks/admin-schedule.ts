...
export const adminScheduleStats: AdminScheduleStat[] = [
  ...
  },
  {
    ...
    detail: "Evening demand is clustering around strength and conditioning sessions.",
    note: "Mock pattern",
    icon: Clock3,
    tone: "warning",
  },
...
export const adminScheduleSessionRecords: AdminScheduleSessionRecord[] = [
  ...
  },
  {
    ...
    focus: "High-output circuit with pacing rounds and recovery intervals.",
  ...
  },
  {
    ...
    attendanceNote: "Needs promotional push to avoid a soft night session.",
  ...
  },
  {
    ...
    highlight: "High-demand premium session",
  },
  {
  ...
  },
  {
    ...
    focus: "Weekend intensity session with partner stations and tempo work.",
