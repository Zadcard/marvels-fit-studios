...
insert into public."RecurringSessionTemplate" ("id", "title", "description", "type", "status", "coachId", "groupId", "location", "capacity", "weekday", "localStartTime", "durationMinutes", "startsOn", "active", "createdById") values
  ('00000000-0000-4000-8000-000000000101', 'Strength Class', 'Compound lifts and progressive loading.', 'GROUP', 'SCHEDULED', 'demo-coach-ahmed', 'demo-group-strength', 'Main floor', 16, extract(dow from current_date)::integer, '17:00', 60, current_date - interval '30 days', true, 'demo-user-admin'),
  ('00000000-0000-4000-8000-000000000102', 'Burning Class', 'Conditioning circuit with progressive intensity.', 'GROUP', 'SCHEDULED', 'demo-coach-nour', 'demo-group-burning', 'Main floor', 16, extract(dow from current_date)::integer, '08:00', 60, current_date - interval '30 days', true, 'demo-user-admin'),
  ('00000000-0000-4000-8000-000000000103', 'Ladies Class', 'Strength, mobility, and low-impact conditioning.', 'GROUP', 'SCHEDULED', 'demo-coach-mariam', 'demo-group-ladies', 'Main floor', 14, extract(dow from current_date)::integer, '09:00', 60, current_date - interval '30 days', true, 'demo-user-admin'),
  ('00000000-0000-4000-8000-000000000104', 'Athlete Conditioning', 'Speed and change-of-direction work.', 'GROUP', 'SCHEDULED', 'demo-coach-youssef', 'demo-group-athlete', 'Outdoor zone', 12, extract(dow from current_date)::integer, '18:30', 60, current_date - interval '30 days', true, 'demo-user-admin'),
  ('00000000-0000-4000-8000-000000000105', 'Calisthenics', 'Bodyweight strength and movement skill.', 'GROUP', 'SCHEDULED', 'demo-coach-khaled', 'demo-group-calisthenics', 'Rig zone', 12, extract(dow from current_date)::integer, '20:00', 60, current_date - interval '30 days', true, 'demo-user-admin')
on conflict do nothing;
...
insert into public."TrainingSession" ("id", "title", "description", "type", "status", "startsAt", "endsAt", "capacity", "location", "coachId", "groupId", "createdById", "sourceTemplateId") values
  ('demo-session-burning-today', 'Burning Class', 'Conditioning circuit with progressive intensity.', 'GROUP', 'SCHEDULED', (current_date + time '08:00') at time zone 'Africa/Cairo', (current_date + time '09:00') at time zone 'Africa/Cairo', 16, 'Main floor', 'demo-coach-nour', 'demo-group-burning', 'demo-user-admin', '00000000-0000-4000-8000-000000000102'),
  ('demo-session-ladies-today', 'Ladies Class', 'Strength, mobility, and low-impact conditioning.', 'GROUP', 'SCHEDULED', (current_date + time '10:00') at time zone 'Africa/Cairo', (current_date + time '11:00') at time zone 'Africa/Cairo', 14, 'Main floor', 'demo-coach-mariam', 'demo-group-ladies', 'demo-user-admin', '00000000-0000-4000-8000-000000000103'),
  ('demo-session-calisthenics-morning', 'Morning Calisthenics', 'Bodyweight strength & skill progressions.', 'GROUP', 'SCHEDULED', (current_date + time '10:00') at time zone 'Africa/Cairo', (current_date + time '11:00') at time zone 'Africa/Cairo', 12, 'Rig zone', 'demo-coach-khaled', 'demo-group-calisthenics', 'demo-user-admin', null),
  ('demo-session-athlete-today', 'Athlete Conditioning', 'Speed and change-of-direction work.', 'GROUP', 'SCHEDULED', (current_date + time '18:30') at time zone 'Africa/Cairo', (current_date + time '19:30') at time zone 'Africa/Cairo', 12, 'Outdoor zone', 'demo-coach-youssef', 'demo-group-athlete', 'demo-user-admin', '00000000-0000-4000-8000-000000000104'),
  ('demo-session-power-today', 'Evening Powerlifting', 'Heavy compound lifts & bar path technique.', 'GROUP', 'SCHEDULED', (current_date + time '18:30') at time zone 'Africa/Cairo', (current_date + time '19:30') at time zone 'Africa/Cairo', 10, 'Main floor', 'demo-coach-ahmed', 'demo-group-strength', 'demo-user-admin', null),
  ('demo-session-calisthenics-today', 'Calisthenics', 'Bodyweight strength and movement skill.', 'GROUP', 'SCHEDULED', (current_date + time '20:00') at time zone 'Africa/Cairo', (current_date + time '21:00') at time zone 'Africa/Cairo', 12, 'Rig zone', 'demo-coach-khaled', 'demo-group-calisthenics', 'demo-user-admin', '00000000-0000-4000-8000-000000000105'),
  ('demo-session-strength-next', 'Strength Class', 'Compound lifts and progressive loading.', 'GROUP', 'SCHEDULED', (current_date + interval '2 days' + time '17:00') at time zone 'Africa/Cairo', (current_date + interval '2 days' + time '18:00') at time zone 'Africa/Cairo', 16, 'Main floor', 'demo-coach-ahmed', 'demo-group-strength', 'demo-user-admin', null),
  ('demo-session-burning-next', 'Burning Class', 'Conditioning circuit with progressive intensity.', 'GROUP', 'SCHEDULED', (current_date + interval '2 days' + time '08:00') at time zone 'Africa/Cairo', (current_date + interval '2 days' + time '09:00') at time zone 'Africa/Cairo', 16, 'Main floor', 'demo-coach-nour', 'demo-group-burning', 'demo-user-admin', null),
  ('demo-session-ladies-next', 'Ladies Class', 'Strength, mobility, and low-impact conditioning.', 'GROUP', 'SCHEDULED', (current_date + interval '3 days' + time '09:00') at time zone 'Africa/Cairo', (current_date + interval '3 days' + time '10:00') at time zone 'Africa/Cairo', 14, 'Main floor', 'demo-coach-mariam', 'demo-group-ladies', 'demo-user-admin', null),
  ('demo-session-athlete-next', 'Athlete Conditioning', 'Speed and change-of-direction work.', 'GROUP', 'SCHEDULED', (current_date + interval '3 days' + time '18:30') at time zone 'Africa/Cairo', (current_date + interval '3 days' + time '19:30') at time zone 'Africa/Cairo', 12, 'Outdoor zone', 'demo-coach-youssef', 'demo-group-athlete', 'demo-user-admin', null)
on conflict do nothing;

insert into public."SessionBooking" ("id", "trainingSessionId", "clientId", "status", "source", "attendedAt") values
  ('demo-booking-nada-today', 'demo-session-ladies-today', 'demo-client-nada', 'BOOKED', 'MANUAL', null),
  ('demo-booking-reham-today', 'demo-session-ladies-today', 'demo-client-reham', 'BOOKED', 'MANUAL', null),
  ('demo-booking-habiba-today', 'demo-session-ladies-today', 'demo-client-habiba', 'BOOKED', 'MANUAL', null),
...
insert into public."TrainingSession" ("id", "title", "description", "type", "status", "startsAt", "endsAt", "capacity", "location", "coachId", "groupId", "createdById", "sourceTemplateId") values
  ('demo-session-strength-today', 'Strength Class', 'Connected Marvel attendance demo.', 'GROUP', 'SCHEDULED', (current_date + time '17:00') at time zone 'Africa/Cairo', (current_date + time '18:00') at time zone 'Africa/Cairo', 16, 'Main floor', 'demo-coach-ahmed', 'demo-group-strength', 'demo-user-admin', '00000000-0000-4000-8000-000000000101')
on conflict do nothing;
