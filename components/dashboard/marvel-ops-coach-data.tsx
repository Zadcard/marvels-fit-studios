...
export function MarvelOpsCoachSchedule({ coachName, sessions }: { coachName: string; sessions: CoachSessionRecord[] }) {
  ...
  return <div className={styles.page}>
    <section className={styles.coachHero}><span>{initials(coachName)}</span><div><h2>My weekly schedule</h2><p>{coachName} &middot; database sessions</p></div><b>{sessions.length} sessions</b></section>
